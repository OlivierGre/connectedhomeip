...
public class ChipDeviceController {
  ...
  public int getCommissioningStagekWaitForDeviceInstallationValue() {
    return getCommissioningStagekWaitForDeviceInstallationValue(deviceControllerPtr);
  }
  ...
  private native int getCommissioningStagekWaitForDeviceInstallationValue(long deviceControllerPtr);
