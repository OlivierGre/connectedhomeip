...
import chip.platform.AndroidNfcManager
...
object ChipClient {
  ...
  private var androidNfcManager : AndroidNfcManager = AndroidNfcManager()
  ...
  fun getAndroidNfcManager() : AndroidNfcManager {
    return androidNfcManager
  }
